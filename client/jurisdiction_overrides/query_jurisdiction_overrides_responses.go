...
func (o *QueryJurisdictionOverridesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewQueryJurisdictionOverridesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewQueryJurisdictionOverridesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 401:
		result := NewQueryJurisdictionOverridesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 404:
		result := NewQueryJurisdictionOverridesNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewQueryJurisdictionOverridesOK() *QueryJurisdictionOverridesOK {
	return &QueryJurisdictionOverridesOK{}
}
...
func (o *QueryJurisdictionOverridesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/jurisdictionoverrides][%d] queryJurisdictionOverridesOK  %+v", 200, o.Payload)
}
func (o *QueryJurisdictionOverridesOK) GetPayload() *models.JurisdictionOverrideModelFetchResult {
	return o.Payload
}

func (o *QueryJurisdictionOverridesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQueryJurisdictionOverridesBadRequest() *QueryJurisdictionOverridesBadRequest {
	return &QueryJurisdictionOverridesBadRequest{}
}
...
func (o *QueryJurisdictionOverridesBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/v2/jurisdictionoverrides][%d] queryJurisdictionOverridesBadRequest ", 400)
}

func (o *QueryJurisdictionOverridesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQueryJurisdictionOverridesUnauthorized() *QueryJurisdictionOverridesUnauthorized {
	return &QueryJurisdictionOverridesUnauthorized{}
}
...
func (o *QueryJurisdictionOverridesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v2/jurisdictionoverrides][%d] queryJurisdictionOverridesUnauthorized ", 401)
}

func (o *QueryJurisdictionOverridesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQueryJurisdictionOverridesNotFound() *QueryJurisdictionOverridesNotFound {
	return &QueryJurisdictionOverridesNotFound{}
}
...
func (o *QueryJurisdictionOverridesNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v2/jurisdictionoverrides][%d] queryJurisdictionOverridesNotFound ", 404)
}

func (o *QueryJurisdictionOverridesNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

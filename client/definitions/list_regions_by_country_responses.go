...
func (o *ListRegionsByCountryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListRegionsByCountryOK()
...
func (o *ListRegionsByCountryOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/countries/{country}/regions][%d] listRegionsByCountryOK  %+v", 200, o.Payload)
}
func (o *ListRegionsByCountryOK) GetPayload() *models.IsoRegionModelFetchResult {
	return o.Payload
}

func (o *ListRegionsByCountryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.IsoRegionModelFetchResult)

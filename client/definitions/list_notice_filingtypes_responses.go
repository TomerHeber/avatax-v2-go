...
func (o *ListNoticeFilingtypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNoticeFilingtypesOK()
...
func NewListNoticeFilingtypesOK() *ListNoticeFilingtypesOK {
	return &ListNoticeFilingtypesOK{}
}
...
func (o *ListNoticeFilingtypesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticefilingtypes][%d] listNoticeFilingtypesOK  %+v", 200, o.Payload)
}
func (o *ListNoticeFilingtypesOK) GetPayload() *models.NoticeFilingTypeModelFetchResult {
	return o.Payload
}

func (o *ListNoticeFilingtypesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticeFilingTypeModelFetchResult)

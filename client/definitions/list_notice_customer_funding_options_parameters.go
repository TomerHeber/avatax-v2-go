...
// NewListNoticeCustomerFundingOptionsParams creates a new ListNoticeCustomerFundingOptionsParams object,
...
func NewListNoticeCustomerFundingOptionsParams() *ListNoticeCustomerFundingOptionsParams {
	return &ListNoticeCustomerFundingOptionsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListNoticeCustomerFundingOptionsParamsWithTimeout creates a new ListNoticeCustomerFundingOptionsParams object
...
// NewListNoticeCustomerFundingOptionsParamsWithContext creates a new ListNoticeCustomerFundingOptionsParams object
...
// NewListNoticeCustomerFundingOptionsParamsWithHTTPClient creates a new ListNoticeCustomerFundingOptionsParams object
...
func (o *ListNoticeCustomerFundingOptionsParams) WithDefaults() *ListNoticeCustomerFundingOptionsParams {
	o.SetDefaults()
	return o
}
...
func (o *ListNoticeCustomerFundingOptionsParams) SetDefaults() {
	...
	val := ListNoticeCustomerFundingOptionsParams{
...
func (o *ListNoticeCustomerFundingOptionsParams) WithTimeout(timeout time.Duration) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WithContext(ctx context.Context) *ListNoticeCustomerFundingOptionsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list notice customer funding options params
func (o *ListNoticeCustomerFundingOptionsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list notice customer funding options params
func (o *ListNoticeCustomerFundingOptionsParams) WithHTTPClient(client *http.Client) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WithDollarFilter(dollarFilter *string) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WithDollarOrderBy(dollarOrderBy *string) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WithDollarSkip(dollarSkip *int32) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WithDollarTop(dollarTop *int32) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WithXAvalaraClient(xAvalaraClient *string) *ListNoticeCustomerFundingOptionsParams {
...
func (o *ListNoticeCustomerFundingOptionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

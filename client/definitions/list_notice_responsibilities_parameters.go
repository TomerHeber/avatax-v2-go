...
// NewListNoticeResponsibilitiesParams creates a new ListNoticeResponsibilitiesParams object,
...
func NewListNoticeResponsibilitiesParams() *ListNoticeResponsibilitiesParams {
	return &ListNoticeResponsibilitiesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListNoticeResponsibilitiesParamsWithTimeout creates a new ListNoticeResponsibilitiesParams object
...
// NewListNoticeResponsibilitiesParamsWithContext creates a new ListNoticeResponsibilitiesParams object
...
// NewListNoticeResponsibilitiesParamsWithHTTPClient creates a new ListNoticeResponsibilitiesParams object
...
func (o *ListNoticeResponsibilitiesParams) WithDefaults() *ListNoticeResponsibilitiesParams {
	o.SetDefaults()
	return o
}
...
func (o *ListNoticeResponsibilitiesParams) SetDefaults() {
	...
	val := ListNoticeResponsibilitiesParams{
...
func (o *ListNoticeResponsibilitiesParams) WithTimeout(timeout time.Duration) *ListNoticeResponsibilitiesParams {
...
func (o *ListNoticeResponsibilitiesParams) WithContext(ctx context.Context) *ListNoticeResponsibilitiesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list notice responsibilities params
func (o *ListNoticeResponsibilitiesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list notice responsibilities params
func (o *ListNoticeResponsibilitiesParams) WithHTTPClient(client *http.Client) *ListNoticeResponsibilitiesParams {
...
func (o *ListNoticeResponsibilitiesParams) WithDollarSkip(dollarSkip *int32) *ListNoticeResponsibilitiesParams {
...
func (o *ListNoticeResponsibilitiesParams) WithDollarTop(dollarTop *int32) *ListNoticeResponsibilitiesParams {
...
func (o *ListNoticeResponsibilitiesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

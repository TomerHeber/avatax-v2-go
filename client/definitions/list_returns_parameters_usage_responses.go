...
func (o *ListReturnsParametersUsageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListReturnsParametersUsageOK()
...
func NewListReturnsParametersUsageOK() *ListReturnsParametersUsageOK {
	return &ListReturnsParametersUsageOK{}
}
...
func (o *ListReturnsParametersUsageOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/returns/parametersusage][%d] listReturnsParametersUsageOK  %+v", 200, o.Payload)
}
func (o *ListReturnsParametersUsageOK) GetPayload() *models.ReturnsParameterUsageModelFetchResult {
	return o.Payload
}

func (o *ListReturnsParametersUsageOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ReturnsParameterUsageModelFetchResult)

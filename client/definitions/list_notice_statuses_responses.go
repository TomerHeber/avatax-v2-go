...
func (o *ListNoticeStatusesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNoticeStatusesOK()
...
func (o *ListNoticeStatusesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticestatuses][%d] listNoticeStatusesOK  %+v", 200, o.Payload)
}
func (o *ListNoticeStatusesOK) GetPayload() *models.NoticeStatusModelFetchResult {
	return o.Payload
}

func (o *ListNoticeStatusesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticeStatusModelFetchResult)

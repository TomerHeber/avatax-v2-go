...
func (o *ListParametersUsageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListParametersUsageOK()
...
func (o *ListParametersUsageOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/parametersusage][%d] listParametersUsageOK  %+v", 200, o.Payload)
}
func (o *ListParametersUsageOK) GetPayload() *models.ParameterUsageModelFetchResult {
	return o.Payload
}

func (o *ListParametersUsageOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ParameterUsageModelFetchResult)

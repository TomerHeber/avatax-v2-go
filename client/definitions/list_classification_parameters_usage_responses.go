...
func (o *ListClassificationParametersUsageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListClassificationParametersUsageOK()
...
func NewListClassificationParametersUsageOK() *ListClassificationParametersUsageOK {
	return &ListClassificationParametersUsageOK{}
}
...
func (o *ListClassificationParametersUsageOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/classification/parametersusage][%d] listClassificationParametersUsageOK  %+v", 200, o.Payload)
}
func (o *ListClassificationParametersUsageOK) GetPayload() *models.ClassificationParameterUsageMapModelFetchResult {
	return o.Payload
}

func (o *ListClassificationParametersUsageOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ClassificationParameterUsageMapModelFetchResult)

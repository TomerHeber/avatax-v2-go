...
func (o *ListCoverLettersOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/coverletters][%d] listCoverLettersOK  %+v", 200, o.Payload)
}
func (o *ListCoverLettersOK) GetPayload() *models.CoverLetterModelFetchResult {
	return o.Payload
}

func (o *ListCoverLettersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CoverLetterModelFetchResult)

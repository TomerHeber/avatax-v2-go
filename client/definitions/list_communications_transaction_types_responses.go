...
func (o *ListCommunicationsTransactionTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListCommunicationsTransactionTypesOK()
...
func NewListCommunicationsTransactionTypesOK() *ListCommunicationsTransactionTypesOK {
	return &ListCommunicationsTransactionTypesOK{}
}
...
func (o *ListCommunicationsTransactionTypesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/communications/transactiontypes][%d] listCommunicationsTransactionTypesOK  %+v", 200, o.Payload)
}
func (o *ListCommunicationsTransactionTypesOK) GetPayload() *models.CommunicationsTransactionTypeModelFetchResult {
	return o.Payload
}

func (o *ListCommunicationsTransactionTypesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.CommunicationsTransactionTypeModelFetchResult)

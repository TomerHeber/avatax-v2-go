...
// NewListReturnsParametersUsageParams creates a new ListReturnsParametersUsageParams object,
...
func NewListReturnsParametersUsageParams() *ListReturnsParametersUsageParams {
	return &ListReturnsParametersUsageParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListReturnsParametersUsageParamsWithTimeout creates a new ListReturnsParametersUsageParams object
...
// NewListReturnsParametersUsageParamsWithContext creates a new ListReturnsParametersUsageParams object
...
// NewListReturnsParametersUsageParamsWithHTTPClient creates a new ListReturnsParametersUsageParams object
...
func (o *ListReturnsParametersUsageParams) WithDefaults() *ListReturnsParametersUsageParams {
	o.SetDefaults()
	return o
}
...
func (o *ListReturnsParametersUsageParams) SetDefaults() {
	...
	val := ListReturnsParametersUsageParams{
...
func (o *ListReturnsParametersUsageParams) WithTimeout(timeout time.Duration) *ListReturnsParametersUsageParams {
...
func (o *ListReturnsParametersUsageParams) WithContext(ctx context.Context) *ListReturnsParametersUsageParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list returns parameters usage params
func (o *ListReturnsParametersUsageParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list returns parameters usage params
func (o *ListReturnsParametersUsageParams) WithHTTPClient(client *http.Client) *ListReturnsParametersUsageParams {
...
func (o *ListReturnsParametersUsageParams) WithDollarSkip(dollarSkip *int32) *ListReturnsParametersUsageParams {
...
func (o *ListReturnsParametersUsageParams) WithDollarTop(dollarTop *int32) *ListReturnsParametersUsageParams {
...
func (o *ListReturnsParametersUsageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
func (o *ListFilingFrequenciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListFilingFrequenciesOK()
...
func NewListFilingFrequenciesOK() *ListFilingFrequenciesOK {
	return &ListFilingFrequenciesOK{}
}
...
func (o *ListFilingFrequenciesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/filingfrequencies][%d] listFilingFrequenciesOK  %+v", 200, o.Payload)
}
func (o *ListFilingFrequenciesOK) GetPayload() *models.FilingFrequencyModelFetchResult {
	return o.Payload
}

func (o *ListFilingFrequenciesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.FilingFrequencyModelFetchResult)

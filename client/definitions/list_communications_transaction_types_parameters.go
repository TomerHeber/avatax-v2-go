...
// NewListCommunicationsTransactionTypesParams creates a new ListCommunicationsTransactionTypesParams object,
...
func NewListCommunicationsTransactionTypesParams() *ListCommunicationsTransactionTypesParams {
	return &ListCommunicationsTransactionTypesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListCommunicationsTransactionTypesParamsWithTimeout creates a new ListCommunicationsTransactionTypesParams object
...
// NewListCommunicationsTransactionTypesParamsWithContext creates a new ListCommunicationsTransactionTypesParams object
...
// NewListCommunicationsTransactionTypesParamsWithHTTPClient creates a new ListCommunicationsTransactionTypesParams object
...
func (o *ListCommunicationsTransactionTypesParams) WithDefaults() *ListCommunicationsTransactionTypesParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *ListCommunicationsTransactionTypesParams) SetDefaults() {
	var (
		xAvalaraClientDefault = string("Swagger UI; 21.12.0; Custom; 1.0")
	)

	val := ListCommunicationsTransactionTypesParams{
...
func (o *ListCommunicationsTransactionTypesParams) WithTimeout(timeout time.Duration) *ListCommunicationsTransactionTypesParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the list communications transaction types params
func (o *ListCommunicationsTransactionTypesParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the list communications transaction types params
func (o *ListCommunicationsTransactionTypesParams) WithContext(ctx context.Context) *ListCommunicationsTransactionTypesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list communications transaction types params
func (o *ListCommunicationsTransactionTypesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list communications transaction types params
func (o *ListCommunicationsTransactionTypesParams) WithHTTPClient(client *http.Client) *ListCommunicationsTransactionTypesParams {
...
func (o *ListCommunicationsTransactionTypesParams) WithDollarFilter(dollarFilter *string) *ListCommunicationsTransactionTypesParams {
...
func (o *ListCommunicationsTransactionTypesParams) WithDollarOrderBy(dollarOrderBy *string) *ListCommunicationsTransactionTypesParams {
...
func (o *ListCommunicationsTransactionTypesParams) WithDollarSkip(dollarSkip *int32) *ListCommunicationsTransactionTypesParams {
...
func (o *ListCommunicationsTransactionTypesParams) WithDollarTop(dollarTop *int32) *ListCommunicationsTransactionTypesParams {
...
func (o *ListCommunicationsTransactionTypesParams) WithXAvalaraClient(xAvalaraClient *string) *ListCommunicationsTransactionTypesParams {
...
func (o *ListCommunicationsTransactionTypesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

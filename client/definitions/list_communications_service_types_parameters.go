...
// NewListCommunicationsServiceTypesParams creates a new ListCommunicationsServiceTypesParams object,
...
func NewListCommunicationsServiceTypesParams() *ListCommunicationsServiceTypesParams {
	return &ListCommunicationsServiceTypesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListCommunicationsServiceTypesParamsWithTimeout creates a new ListCommunicationsServiceTypesParams object
...
// NewListCommunicationsServiceTypesParamsWithContext creates a new ListCommunicationsServiceTypesParams object
...
// NewListCommunicationsServiceTypesParamsWithHTTPClient creates a new ListCommunicationsServiceTypesParams object
...
func (o *ListCommunicationsServiceTypesParams) WithDefaults() *ListCommunicationsServiceTypesParams {
	o.SetDefaults()
	return o
}
...
func (o *ListCommunicationsServiceTypesParams) SetDefaults() {
	...
	val := ListCommunicationsServiceTypesParams{
...
func (o *ListCommunicationsServiceTypesParams) WithTimeout(timeout time.Duration) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithContext(ctx context.Context) *ListCommunicationsServiceTypesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list communications service types params
func (o *ListCommunicationsServiceTypesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list communications service types params
func (o *ListCommunicationsServiceTypesParams) WithHTTPClient(client *http.Client) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithDollarFilter(dollarFilter *string) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithDollarOrderBy(dollarOrderBy *string) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithDollarSkip(dollarSkip *int32) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithDollarTop(dollarTop *int32) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithXAvalaraClient(xAvalaraClient *string) *ListCommunicationsServiceTypesParams {
...
func (o *ListCommunicationsServiceTypesParams) WithID(id int32) *ListCommunicationsServiceTypesParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the list communications service types params
func (o *ListCommunicationsServiceTypesParams) SetID(id int32) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *ListCommunicationsServiceTypesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

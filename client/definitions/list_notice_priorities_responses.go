...
func (o *ListNoticePrioritiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNoticePrioritiesOK()
...
func (o *ListNoticePrioritiesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticepriorities][%d] listNoticePrioritiesOK  %+v", 200, o.Payload)
}
func (o *ListNoticePrioritiesOK) GetPayload() *models.NoticePriorityModelFetchResult {
	return o.Payload
}

func (o *ListNoticePrioritiesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticePriorityModelFetchResult)

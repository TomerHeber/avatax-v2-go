...
func (o *ListTaxAuthorityTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListTaxAuthorityTypesOK()
...
func NewListTaxAuthorityTypesOK() *ListTaxAuthorityTypesOK {
	return &ListTaxAuthorityTypesOK{}
}
...
func (o *ListTaxAuthorityTypesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/taxauthoritytypes][%d] listTaxAuthorityTypesOK  %+v", 200, o.Payload)
}
func (o *ListTaxAuthorityTypesOK) GetPayload() *models.TaxAuthorityTypeModelFetchResult {
	return o.Payload
}

func (o *ListTaxAuthorityTypesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.TaxAuthorityTypeModelFetchResult)

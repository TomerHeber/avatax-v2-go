...
func (o *ListJurisdictionsByAddressReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListJurisdictionsByAddressOK()
...
func NewListJurisdictionsByAddressOK() *ListJurisdictionsByAddressOK {
	return &ListJurisdictionsByAddressOK{}
}
...
func (o *ListJurisdictionsByAddressOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/jurisdictionsnearaddress][%d] listJurisdictionsByAddressOK  %+v", 200, o.Payload)
}
func (o *ListJurisdictionsByAddressOK) GetPayload() *models.JurisdictionOverrideModelFetchResult {
	return o.Payload
}

func (o *ListJurisdictionsByAddressOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

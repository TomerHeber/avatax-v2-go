...
func (o *ListNexusByTaxTypeGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNexusByTaxTypeGroupOK()
...
func NewListNexusByTaxTypeGroupOK() *ListNexusByTaxTypeGroupOK {
	return &ListNexusByTaxTypeGroupOK{}
}
...
func (o *ListNexusByTaxTypeGroupOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/nexus/bytaxtypegroup/{taxTypeGroup}][%d] listNexusByTaxTypeGroupOK  %+v", 200, o.Payload)
}
func (o *ListNexusByTaxTypeGroupOK) GetPayload() *models.NexusModelFetchResult {
	return o.Payload
}

func (o *ListNexusByTaxTypeGroupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

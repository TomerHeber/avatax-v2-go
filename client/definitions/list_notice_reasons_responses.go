...
func (o *ListNoticeReasonsOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticereasons][%d] listNoticeReasonsOK  %+v", 200, o.Payload)
}
func (o *ListNoticeReasonsOK) GetPayload() *models.NoticeReasonModelFetchResult {
	return o.Payload
}

func (o *ListNoticeReasonsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticeReasonModelFetchResult)

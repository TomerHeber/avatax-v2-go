...
func (o *ListNoticeRootCausesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNoticeRootCausesOK()
...
func (o *ListNoticeRootCausesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticerootcauses][%d] listNoticeRootCausesOK  %+v", 200, o.Payload)
}
func (o *ListNoticeRootCausesOK) GetPayload() *models.NoticeRootCauseModelFetchResult {
	return o.Payload
}

func (o *ListNoticeRootCausesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticeRootCauseModelFetchResult)

...
func (o *ListTaxAuthorityFormsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListTaxAuthorityFormsOK()
...
func NewListTaxAuthorityFormsOK() *ListTaxAuthorityFormsOK {
	return &ListTaxAuthorityFormsOK{}
}
...
func (o *ListTaxAuthorityFormsOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/taxauthorityforms][%d] listTaxAuthorityFormsOK  %+v", 200, o.Payload)
}
func (o *ListTaxAuthorityFormsOK) GetPayload() *models.TaxAuthorityFormModelFetchResult {
	return o.Payload
}

func (o *ListTaxAuthorityFormsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.TaxAuthorityFormModelFetchResult)

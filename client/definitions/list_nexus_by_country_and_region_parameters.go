...
// NewListNexusByCountryAndRegionParams creates a new ListNexusByCountryAndRegionParams object,
...
func NewListNexusByCountryAndRegionParams() *ListNexusByCountryAndRegionParams {
	return &ListNexusByCountryAndRegionParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListNexusByCountryAndRegionParamsWithTimeout creates a new ListNexusByCountryAndRegionParams object
...
// NewListNexusByCountryAndRegionParamsWithContext creates a new ListNexusByCountryAndRegionParams object
...
// NewListNexusByCountryAndRegionParamsWithHTTPClient creates a new ListNexusByCountryAndRegionParams object
...
func (o *ListNexusByCountryAndRegionParams) WithDefaults() *ListNexusByCountryAndRegionParams {
	o.SetDefaults()
	return o
}
...
func (o *ListNexusByCountryAndRegionParams) SetDefaults() {
	...
	val := ListNexusByCountryAndRegionParams{
...
func (o *ListNexusByCountryAndRegionParams) WithTimeout(timeout time.Duration) *ListNexusByCountryAndRegionParams {
...
func (o *ListNexusByCountryAndRegionParams) WithContext(ctx context.Context) *ListNexusByCountryAndRegionParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list nexus by country and region params
func (o *ListNexusByCountryAndRegionParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list nexus by country and region params
func (o *ListNexusByCountryAndRegionParams) WithHTTPClient(client *http.Client) *ListNexusByCountryAndRegionParams {
...
func (o *ListNexusByCountryAndRegionParams) WithDollarFilter(dollarFilter *string) *ListNexusByCountryAndRegionParams {
...
func (o *ListNexusByCountryAndRegionParams) WithDollarSkip(dollarSkip *int32) *ListNexusByCountryAndRegionParams {
...
func (o *ListNexusByCountryAndRegionParams) WithDollarTop(dollarTop *int32) *ListNexusByCountryAndRegionParams {
...
func (o *ListNexusByCountryAndRegionParams) WithCountry(country string) *ListNexusByCountryAndRegionParams {
...
func (o *ListNexusByCountryAndRegionParams) WithRegion(region string) *ListNexusByCountryAndRegionParams {
	o.SetRegion(region)
	return o
}
...
func (o *ListNexusByCountryAndRegionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

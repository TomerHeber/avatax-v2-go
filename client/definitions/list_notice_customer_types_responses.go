...
func (o *ListNoticeCustomerTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNoticeCustomerTypesOK()
...
func NewListNoticeCustomerTypesOK() *ListNoticeCustomerTypesOK {
	return &ListNoticeCustomerTypesOK{}
}
...
func (o *ListNoticeCustomerTypesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticecustomertypes][%d] listNoticeCustomerTypesOK  %+v", 200, o.Payload)
}
func (o *ListNoticeCustomerTypesOK) GetPayload() *models.NoticeCustomerTypeModelFetchResult {
	return o.Payload
}

func (o *ListNoticeCustomerTypesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticeCustomerTypeModelFetchResult)

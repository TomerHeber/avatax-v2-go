...
func (o *ListPostalCodesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/postalcodes][%d] listPostalCodesOK  %+v", 200, o.Payload)
}
func (o *ListPostalCodesOK) GetPayload() *models.PostalCodeModelFetchResult {
	return o.Payload
}

func (o *ListPostalCodesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PostalCodeModelFetchResult)

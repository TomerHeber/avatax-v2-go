...
func (o *ListCurrenciesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/currencies][%d] listCurrenciesOK  %+v", 200, o.Payload)
}
func (o *ListCurrenciesOK) GetPayload() *models.CurrencyModelFetchResult {
	return o.Payload
}
...
func (o *ListCurrenciesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CurrencyModelFetchResult)

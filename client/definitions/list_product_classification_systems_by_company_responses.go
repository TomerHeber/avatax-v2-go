...
func (o *ListProductClassificationSystemsByCompanyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListProductClassificationSystemsByCompanyOK()
...
func NewListProductClassificationSystemsByCompanyOK() *ListProductClassificationSystemsByCompanyOK {
	return &ListProductClassificationSystemsByCompanyOK{}
}
...
func (o *ListProductClassificationSystemsByCompanyOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/productclassificationsystems/bycompany/{companyCode}][%d] listProductClassificationSystemsByCompanyOK  %+v", 200, o.Payload)
}
func (o *ListProductClassificationSystemsByCompanyOK) GetPayload() *models.ProductClassificationSystemModelFetchResult {
	return o.Payload
}

func (o *ListProductClassificationSystemsByCompanyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

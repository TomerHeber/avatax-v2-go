...
func (o *ListNoticeCustomerFundingOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListNoticeCustomerFundingOptionsOK()
...
func NewListNoticeCustomerFundingOptionsOK() *ListNoticeCustomerFundingOptionsOK {
	return &ListNoticeCustomerFundingOptionsOK{}
}
...
func (o *ListNoticeCustomerFundingOptionsOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/noticecustomerfundingoptions][%d] listNoticeCustomerFundingOptionsOK  %+v", 200, o.Payload)
}
func (o *ListNoticeCustomerFundingOptionsOK) GetPayload() *models.NoticeCustomerFundingOptionModelFetchResult {
	return o.Payload
}

func (o *ListNoticeCustomerFundingOptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NoticeCustomerFundingOptionModelFetchResult)

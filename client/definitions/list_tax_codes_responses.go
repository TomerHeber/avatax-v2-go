...
func (o *ListTaxCodesOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/definitions/taxcodes][%d] listTaxCodesOK  %+v", 200, o.Payload)
}
func (o *ListTaxCodesOK) GetPayload() *models.TaxCodeModelFetchResult {
	return o.Payload
}

func (o *ListTaxCodesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

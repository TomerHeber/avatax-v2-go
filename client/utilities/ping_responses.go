...
func (o *PingOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/utilities/ping][%d] pingOK  %+v", 200, o.Payload)
}
...
func (o *PingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.PingResultModel)
...
func (o *PingBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/v2/utilities/ping][%d] pingBadRequest ", 400)
}
...
func (o *PingUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v2/utilities/ping][%d] pingUnauthorized ", 401)
}

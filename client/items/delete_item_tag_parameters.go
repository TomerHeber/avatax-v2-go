...
// NewDeleteItemTagParams creates a new DeleteItemTagParams object,
...
func NewDeleteItemTagParams() *DeleteItemTagParams {
	return &DeleteItemTagParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteItemTagParamsWithTimeout creates a new DeleteItemTagParams object
...
// NewDeleteItemTagParamsWithContext creates a new DeleteItemTagParams object
...
// NewDeleteItemTagParamsWithHTTPClient creates a new DeleteItemTagParams object
...
func (o *DeleteItemTagParams) WithContext(ctx context.Context) *DeleteItemTagParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteItemTagParams) WithItemTagDetailID(itemTagDetailID int32) *DeleteItemTagParams {
	o.SetItemTagDetailID(itemTagDetailID)
	return o
}
...
func (o *DeleteItemTagParams) SetItemTagDetailID(itemTagDetailID int32) {
	o.ItemTagDetailID = itemTagDetailID
}
...
func (o *DeleteItemTagParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param itemTagDetailId
	if err := r.SetPathParam("itemTagDetailId", swag.FormatInt32(o.ItemTagDetailID)); err != nil {
		return err
	}

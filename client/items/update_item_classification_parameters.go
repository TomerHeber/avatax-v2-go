...
// NewUpdateItemClassificationParams creates a new UpdateItemClassificationParams object,
...
func NewUpdateItemClassificationParams() *UpdateItemClassificationParams {
	return &UpdateItemClassificationParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateItemClassificationParamsWithTimeout creates a new UpdateItemClassificationParams object
...
// NewUpdateItemClassificationParamsWithContext creates a new UpdateItemClassificationParams object
...
// NewUpdateItemClassificationParamsWithHTTPClient creates a new UpdateItemClassificationParams object
...
func (o *UpdateItemClassificationParams) WithDefaults() *UpdateItemClassificationParams {
	o.SetDefaults()
	return o
}
...
func (o *UpdateItemClassificationParams) SetDefaults() {
	...
	val := UpdateItemClassificationParams{
...
func (o *UpdateItemClassificationParams) WithTimeout(timeout time.Duration) *UpdateItemClassificationParams {
...
func (o *UpdateItemClassificationParams) WithContext(ctx context.Context) *UpdateItemClassificationParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateItemClassificationParams) WithHTTPClient(client *http.Client) *UpdateItemClassificationParams {
...
func (o *UpdateItemClassificationParams) WithBody(body *models.ItemClassificationInputModel) *UpdateItemClassificationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update item classification params
func (o *UpdateItemClassificationParams) SetBody(body *models.ItemClassificationInputModel) {
	o.Body = body
}

// WithCompanyID adds the companyID to the update item classification params
func (o *UpdateItemClassificationParams) WithCompanyID(companyID int32) *UpdateItemClassificationParams {
...
func (o *UpdateItemClassificationParams) WithID(id int64) *UpdateItemClassificationParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update item classification params
func (o *UpdateItemClassificationParams) SetID(id int64) {
	o.ID = id
}

// WithItemID adds the itemID to the update item classification params
func (o *UpdateItemClassificationParams) WithItemID(itemID int64) *UpdateItemClassificationParams {
	o.SetItemID(itemID)
	return o
}
...
func (o *UpdateItemClassificationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

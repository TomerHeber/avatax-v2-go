...
func (o *GetCertificateOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/companies/{companyId}/certificates/{id}][%d] getCertificateOK  %+v", 200, o.Payload)
}
...
func (o *GetCertificateBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/v2/companies/{companyId}/certificates/{id}][%d] getCertificateBadRequest ", 400)
}
...
func (o *GetCertificateUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v2/companies/{companyId}/certificates/{id}][%d] getCertificateUnauthorized ", 401)
}
...
func (o *GetCertificateNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v2/companies/{companyId}/certificates/{id}][%d] getCertificateNotFound ", 404)
}

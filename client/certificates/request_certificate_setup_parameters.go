...
// NewRequestCertificateSetupParams creates a new RequestCertificateSetupParams object,
...
func NewRequestCertificateSetupParams() *RequestCertificateSetupParams {
	return &RequestCertificateSetupParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRequestCertificateSetupParamsWithTimeout creates a new RequestCertificateSetupParams object
...
// NewRequestCertificateSetupParamsWithContext creates a new RequestCertificateSetupParams object
...
// NewRequestCertificateSetupParamsWithHTTPClient creates a new RequestCertificateSetupParams object
...
func (o *RequestCertificateSetupParams) WithDefaults() *RequestCertificateSetupParams {
	o.SetDefaults()
	return o
}
...
func (o *RequestCertificateSetupParams) SetDefaults() {
	...
	val := RequestCertificateSetupParams{
...
func (o *RequestCertificateSetupParams) WithTimeout(timeout time.Duration) *RequestCertificateSetupParams {
...
func (o *RequestCertificateSetupParams) WithContext(ctx context.Context) *RequestCertificateSetupParams {
	o.SetContext(ctx)
	return o
}
...
func (o *RequestCertificateSetupParams) WithHTTPClient(client *http.Client) *RequestCertificateSetupParams {
...
func (o *RequestCertificateSetupParams) WithCompanyID(companyID int32) *RequestCertificateSetupParams {
...
func (o *RequestCertificateSetupParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

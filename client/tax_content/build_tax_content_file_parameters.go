...
// NewBuildTaxContentFileParams creates a new BuildTaxContentFileParams object,
...
func NewBuildTaxContentFileParams() *BuildTaxContentFileParams {
	return &BuildTaxContentFileParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewBuildTaxContentFileParamsWithTimeout creates a new BuildTaxContentFileParams object
...
// NewBuildTaxContentFileParamsWithContext creates a new BuildTaxContentFileParams object
...
// NewBuildTaxContentFileParamsWithHTTPClient creates a new BuildTaxContentFileParams object
...
func (o *BuildTaxContentFileParams) WithDefaults() *BuildTaxContentFileParams {
	o.SetDefaults()
	return o
}
...
func (o *BuildTaxContentFileParams) WithTimeout(timeout time.Duration) *BuildTaxContentFileParams {
...
func (o *BuildTaxContentFileParams) WithContext(ctx context.Context) *BuildTaxContentFileParams {
	o.SetContext(ctx)
	return o
}
...
func (o *BuildTaxContentFileParams) WithBody(body *models.PointOfSaleDataRequestModel) *BuildTaxContentFileParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the build tax content file params
func (o *BuildTaxContentFileParams) SetBody(body *models.PointOfSaleDataRequestModel) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *BuildTaxContentFileParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

...
// NewLockTransactionParams creates a new LockTransactionParams object,
...
func NewLockTransactionParams() *LockTransactionParams {
	return &LockTransactionParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewLockTransactionParamsWithTimeout creates a new LockTransactionParams object
...
// NewLockTransactionParamsWithContext creates a new LockTransactionParams object
...
// NewLockTransactionParamsWithHTTPClient creates a new LockTransactionParams object
...
func (o *LockTransactionParams) WithContext(ctx context.Context) *LockTransactionParams {
	o.SetContext(ctx)
	return o
}
...
func (o *LockTransactionParams) WithBody(body *models.LockTransactionModel) *LockTransactionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the lock transaction params
func (o *LockTransactionParams) SetBody(body *models.LockTransactionModel) {
	o.Body = body
}

...
func (o *ListAttributesForCustomerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListAttributesForCustomerOK()
...
func NewListAttributesForCustomerOK() *ListAttributesForCustomerOK {
	return &ListAttributesForCustomerOK{}
}
...
func (o *ListAttributesForCustomerOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/companies/{companyId}/customers/{customerCode}/attributes][%d] listAttributesForCustomerOK  %+v", 200, o.Payload)
}
func (o *ListAttributesForCustomerOK) GetPayload() *models.CustomerAttributeModelFetchResult {
	return o.Payload
}

func (o *ListAttributesForCustomerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *GetMultiDocumentTransactionByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetMultiDocumentTransactionByIDOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewGetMultiDocumentTransactionByIDBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 401:
		result := NewGetMultiDocumentTransactionByIDUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 404:
		result := NewGetMultiDocumentTransactionByIDNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetMultiDocumentTransactionByIDOK() *GetMultiDocumentTransactionByIDOK {
	return &GetMultiDocumentTransactionByIDOK{}
}
...
func (o *GetMultiDocumentTransactionByIDOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/transactions/multidocument/{id}][%d] getMultiDocumentTransactionByIdOK  %+v", 200, o.Payload)
}
func (o *GetMultiDocumentTransactionByIDOK) GetPayload() *models.MultiDocumentModel {
	return o.Payload
}

func (o *GetMultiDocumentTransactionByIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMultiDocumentTransactionByIDBadRequest() *GetMultiDocumentTransactionByIDBadRequest {
	return &GetMultiDocumentTransactionByIDBadRequest{}
}
...
func (o *GetMultiDocumentTransactionByIDBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/v2/transactions/multidocument/{id}][%d] getMultiDocumentTransactionByIdBadRequest ", 400)
}

func (o *GetMultiDocumentTransactionByIDBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMultiDocumentTransactionByIDUnauthorized() *GetMultiDocumentTransactionByIDUnauthorized {
	return &GetMultiDocumentTransactionByIDUnauthorized{}
}
...
func (o *GetMultiDocumentTransactionByIDUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v2/transactions/multidocument/{id}][%d] getMultiDocumentTransactionByIdUnauthorized ", 401)
}

func (o *GetMultiDocumentTransactionByIDUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetMultiDocumentTransactionByIDNotFound() *GetMultiDocumentTransactionByIDNotFound {
	return &GetMultiDocumentTransactionByIDNotFound{}
}
...
func (o *GetMultiDocumentTransactionByIDNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v2/transactions/multidocument/{id}][%d] getMultiDocumentTransactionByIdNotFound ", 404)
}

func (o *GetMultiDocumentTransactionByIDNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (m *ExposureZoneModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ExposureZoneModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExposureZoneModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ExposureZoneModelFetchResult

...
func (m *JurisdictionModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *JurisdictionModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JurisdictionModelFetchResult) UnmarshalBinary(b []byte) error {
	var res JurisdictionModelFetchResult

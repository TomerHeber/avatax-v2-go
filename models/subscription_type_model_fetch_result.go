...
func (m *SubscriptionTypeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SubscriptionTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *SubscriptionTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubscriptionTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res SubscriptionTypeModelFetchResult

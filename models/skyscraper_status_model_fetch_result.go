...
func (m *SkyscraperStatusModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SkyscraperStatusModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *SkyscraperStatusModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SkyscraperStatusModelFetchResult) UnmarshalBinary(b []byte) error {
	var res SkyscraperStatusModelFetchResult

...
func (m *CompanyParameterDetailModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CompanyParameterDetailModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CompanyParameterDetailModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CompanyParameterDetailModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CompanyParameterDetailModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CompanyParameterDetailModelFetchResult

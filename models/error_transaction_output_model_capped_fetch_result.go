...
func (m *ErrorTransactionOutputModelCappedFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ErrorTransactionOutputModelCappedFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ErrorTransactionOutputModelCappedFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ErrorTransactionOutputModelCappedFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ErrorTransactionOutputModelCappedFetchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ErrorTransactionOutputModelCappedFetchResult) UnmarshalBinary(b []byte) error {
	var res ErrorTransactionOutputModelCappedFetchResult

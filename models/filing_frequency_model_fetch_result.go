...
func (m *FilingFrequencyModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FilingFrequencyModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *FilingFrequencyModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FilingFrequencyModelFetchResult) UnmarshalBinary(b []byte) error {
	var res FilingFrequencyModelFetchResult

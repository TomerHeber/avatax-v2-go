...
func (m *CustomerSupplierModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerSupplierModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CustomerSupplierModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CustomerSupplierModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CustomerSupplierModelFetchResult

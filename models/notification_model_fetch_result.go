...
func (m *NotificationModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NotificationModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NotificationModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NotificationModelFetchResult

...
func (m *FormMasterModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *FormMasterModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FormMasterModelFetchResult) UnmarshalBinary(b []byte) error {
	var res FormMasterModelFetchResult

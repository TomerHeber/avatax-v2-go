...
func (m *MultiDocumentModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *MultiDocumentModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiDocumentModelFetchResult) UnmarshalBinary(b []byte) error {
	var res MultiDocumentModelFetchResult

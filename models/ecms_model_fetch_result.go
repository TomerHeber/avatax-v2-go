...
func (m *EcmsModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *EcmsModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {

...
func (m *AvaFileFormModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *AvaFileFormModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AvaFileFormModelFetchResult) UnmarshalBinary(b []byte) error {
	var res AvaFileFormModelFetchResult

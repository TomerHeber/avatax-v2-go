...
func (m *CommunicationsTSPairModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CommunicationsTSPairModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CommunicationsTSPairModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommunicationsTSPairModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CommunicationsTSPairModelFetchResult

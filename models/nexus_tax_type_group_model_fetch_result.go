...
func (m *NexusTaxTypeGroupModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NexusTaxTypeGroupModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NexusTaxTypeGroupModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NexusTaxTypeGroupModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NexusTaxTypeGroupModelFetchResult

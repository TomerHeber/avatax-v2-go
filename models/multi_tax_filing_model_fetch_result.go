...
func (m *MultiTaxFilingModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *MultiTaxFilingModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiTaxFilingModelFetchResult) UnmarshalBinary(b []byte) error {
	var res MultiTaxFilingModelFetchResult

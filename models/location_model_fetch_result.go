...
func (m *LocationModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *LocationModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LocationModelFetchResult) UnmarshalBinary(b []byte) error {
	var res LocationModelFetchResult

...
func (m *SecurityRoleModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *SecurityRoleModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityRoleModelFetchResult) UnmarshalBinary(b []byte) error {
	var res SecurityRoleModelFetchResult

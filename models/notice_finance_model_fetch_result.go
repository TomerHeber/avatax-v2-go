...
func (m *NoticeFinanceModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeFinanceModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeFinanceModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeFinanceModelFetchResult

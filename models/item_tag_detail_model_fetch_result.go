...
func (m *ItemTagDetailModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ItemTagDetailModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItemTagDetailModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ItemTagDetailModelFetchResult

...
func (m *CustomerAttributeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerAttributeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CustomerAttributeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CustomerAttributeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CustomerAttributeModelFetchResult

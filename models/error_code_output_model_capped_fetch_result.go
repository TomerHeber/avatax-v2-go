...
func (m *ErrorCodeOutputModelCappedFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ErrorCodeOutputModelCappedFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ErrorCodeOutputModelCappedFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ErrorCodeOutputModelCappedFetchResult) UnmarshalBinary(b []byte) error {
	var res ErrorCodeOutputModelCappedFetchResult

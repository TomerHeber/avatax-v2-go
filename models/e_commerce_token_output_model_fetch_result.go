...
func (m *ECommerceTokenOutputModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ECommerceTokenOutputModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ECommerceTokenOutputModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ECommerceTokenOutputModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ECommerceTokenOutputModelFetchResult

...
func (m *JurisdictionOverrideModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JurisdictionOverrideModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *JurisdictionOverrideModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JurisdictionOverrideModelFetchResult) UnmarshalBinary(b []byte) error {
	var res JurisdictionOverrideModelFetchResult

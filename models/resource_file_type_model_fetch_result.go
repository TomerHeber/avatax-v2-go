...
func (m *ResourceFileTypeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResourceFileTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ResourceFileTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourceFileTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ResourceFileTypeModelFetchResult

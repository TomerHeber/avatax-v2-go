...
func (m *SubscriptionModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *SubscriptionModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SubscriptionModelFetchResult) UnmarshalBinary(b []byte) error {
	var res SubscriptionModelFetchResult

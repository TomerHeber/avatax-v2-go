...
func (m *UPCModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *UPCModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {

...
func (m *NoticeFilingTypeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeFilingTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeFilingTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeFilingTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeFilingTypeModelFetchResult

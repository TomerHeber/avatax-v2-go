...
func (m *FiledReturnModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *FiledReturnModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FiledReturnModelFetchResult) UnmarshalBinary(b []byte) error {
	var res FiledReturnModelFetchResult

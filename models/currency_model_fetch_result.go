...
func (m *CurrencyModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CurrencyModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CurrencyModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CurrencyModelFetchResult

...
func (m *TaxSubTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxSubTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxSubTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxSubTypeModelFetchResult

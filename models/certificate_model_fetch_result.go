...
func (m *CertificateModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CertificateModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CertificateModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CertificateModelFetchResult

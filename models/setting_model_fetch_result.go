...
func (m *SettingModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *SettingModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SettingModelFetchResult) UnmarshalBinary(b []byte) error {
	var res SettingModelFetchResult

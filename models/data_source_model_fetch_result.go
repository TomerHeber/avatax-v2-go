...
func (m *DataSourceModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *DataSourceModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DataSourceModelFetchResult) UnmarshalBinary(b []byte) error {
	var res DataSourceModelFetchResult

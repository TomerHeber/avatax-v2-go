...
func (m *NoticeRootCauseModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeRootCauseModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeRootCauseModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeRootCauseModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeRootCauseModelFetchResult

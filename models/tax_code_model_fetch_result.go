...
func (m *TaxCodeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxCodeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxCodeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxCodeModelFetchResult

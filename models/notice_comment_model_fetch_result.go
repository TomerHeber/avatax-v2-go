...
func (m *NoticeCommentModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeCommentModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeCommentModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeCommentModelFetchResult

...
func (m *ClassificationParameterUsageMapModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClassificationParameterUsageMapModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ClassificationParameterUsageMapModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ClassificationParameterUsageMapModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClassificationParameterUsageMapModelFetchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ClassificationParameterUsageMapModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ClassificationParameterUsageMapModelFetchResult

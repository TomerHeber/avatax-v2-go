...
func (m *IsoRegionModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *IsoRegionModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IsoRegionModelFetchResult) UnmarshalBinary(b []byte) error {
	var res IsoRegionModelFetchResult

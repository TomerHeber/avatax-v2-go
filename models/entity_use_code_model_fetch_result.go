...
func (m *EntityUseCodeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *EntityUseCodeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EntityUseCodeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res EntityUseCodeModelFetchResult

...
func (m *NoticeStatusModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeStatusModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeStatusModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeStatusModelFetchResult

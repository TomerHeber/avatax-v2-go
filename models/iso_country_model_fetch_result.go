...
func (m *IsoCountryModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *IsoCountryModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IsoCountryModelFetchResult) UnmarshalBinary(b []byte) error {
	var res IsoCountryModelFetchResult

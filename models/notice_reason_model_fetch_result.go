...
func (m *NoticeReasonModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeReasonModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeReasonModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeReasonModelFetchResult

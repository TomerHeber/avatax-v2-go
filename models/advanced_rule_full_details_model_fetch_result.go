...
func (m *AdvancedRuleFullDetailsModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AdvancedRuleFullDetailsModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *AdvancedRuleFullDetailsModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AdvancedRuleFullDetailsModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedRuleFullDetailsModelFetchResult) UnmarshalBinary(b []byte) error {
	var res AdvancedRuleFullDetailsModelFetchResult

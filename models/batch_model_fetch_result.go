...
func (m *BatchModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *BatchModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {

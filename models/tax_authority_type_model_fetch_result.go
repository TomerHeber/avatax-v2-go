...
func (m *TaxAuthorityTypeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TaxAuthorityTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxAuthorityTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxAuthorityTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxAuthorityTypeModelFetchResult

...
func (m *PreferredProgramModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PreferredProgramModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *PreferredProgramModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PreferredProgramModelFetchResult) UnmarshalBinary(b []byte) error {
	var res PreferredProgramModelFetchResult

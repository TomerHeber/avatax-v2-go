...
func (m *NoticeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeModelFetchResult

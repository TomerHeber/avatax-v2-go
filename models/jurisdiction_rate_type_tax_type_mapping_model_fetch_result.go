...
func (m *JurisdictionRateTypeTaxTypeMappingModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JurisdictionRateTypeTaxTypeMappingModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *JurisdictionRateTypeTaxTypeMappingModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JurisdictionRateTypeTaxTypeMappingModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JurisdictionRateTypeTaxTypeMappingModelFetchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *JurisdictionRateTypeTaxTypeMappingModelFetchResult) UnmarshalBinary(b []byte) error {
	var res JurisdictionRateTypeTaxTypeMappingModelFetchResult

...
func (m *FilingCalendarModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *FilingCalendarModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FilingCalendarModelFetchResult) UnmarshalBinary(b []byte) error {
	var res FilingCalendarModelFetchResult

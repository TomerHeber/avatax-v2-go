...
func (m *RateTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *RateTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RateTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res RateTypeModelFetchResult

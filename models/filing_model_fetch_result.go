...
func (m *FilingModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *FilingModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FilingModelFetchResult) UnmarshalBinary(b []byte) error {
	var res FilingModelFetchResult

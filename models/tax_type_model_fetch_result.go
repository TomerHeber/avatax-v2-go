...
func (m *TaxTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxTypeModelFetchResult

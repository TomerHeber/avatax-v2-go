...
// MultiDocumentLineItemModel Represents one line item in a MultiDocument transaction
...
func (m *MultiDocumentLineItemModel) validateAddresses(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateAmount(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateBusinessIdentificationNo(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateCategory(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateCustomerUsageType(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateDescription(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateEntityUseCode(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateHsCode(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateItemCode(formats strfmt.Registry) error {
...
var multiDocumentLineItemModelTypeMarketplaceLiabilityTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		multiDocumentLineItemModelTypeMarketplaceLiabilityTypePropEnum = append(multiDocumentLineItemModelTypeMarketplaceLiabilityTypePropEnum, v)
	}
}
...
// prop value enum
func (m *MultiDocumentLineItemModel) validateMarketplaceLiabilityTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, multiDocumentLineItemModelTypeMarketplaceLiabilityTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *MultiDocumentLineItemModel) validateMarketplaceLiabilityType(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateMerchantSellerIdentifier(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateNumber(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateOriginationDocumentID(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateOriginationSite(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateParameters(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateRef1(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateRef2(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateRevenueAccount(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateSummary(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateTaxCode(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateTaxOverride(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) validateUserDefinedFields(formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) contextValidateAddresses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) contextValidateTaxOverride(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) contextValidateUserDefinedFields(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MultiDocumentLineItemModel) UnmarshalBinary(b []byte) error {
	var res MultiDocumentLineItemModel

...
func (m *PostalCodeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *PostalCodeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostalCodeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res PostalCodeModelFetchResult

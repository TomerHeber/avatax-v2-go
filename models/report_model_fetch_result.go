...
func (m *ReportModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ReportModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReportModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ReportModelFetchResult

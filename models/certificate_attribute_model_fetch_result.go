...
func (m *CertificateAttributeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CertificateAttributeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CertificateAttributeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CertificateAttributeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CertificateAttributeModelFetchResult

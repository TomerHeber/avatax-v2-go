...
func (m *NoticeRootCauseDetailModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeRootCauseDetailModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeRootCauseDetailModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeRootCauseDetailModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeRootCauseDetailModelFetchResult

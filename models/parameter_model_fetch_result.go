...
func (m *ParameterModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ParameterModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ParameterModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ParameterModelFetchResult

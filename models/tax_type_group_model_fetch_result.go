...
func (m *TaxTypeGroupModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxTypeGroupModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxTypeGroupModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxTypeGroupModelFetchResult

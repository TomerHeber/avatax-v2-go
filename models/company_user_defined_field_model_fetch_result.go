...
func (m *CompanyUserDefinedFieldModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CompanyUserDefinedFieldModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CompanyUserDefinedFieldModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CompanyUserDefinedFieldModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CompanyUserDefinedFieldModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CompanyUserDefinedFieldModelFetchResult

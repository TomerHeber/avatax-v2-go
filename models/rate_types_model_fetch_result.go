...
func (m *RateTypesModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *RateTypesModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RateTypesModelFetchResult) UnmarshalBinary(b []byte) error {
	var res RateTypesModelFetchResult

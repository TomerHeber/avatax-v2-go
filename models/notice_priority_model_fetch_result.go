...
func (m *NoticePriorityModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticePriorityModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticePriorityModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticePriorityModelFetchResult

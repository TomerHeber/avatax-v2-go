...
func (m *CompanyModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CompanyModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CompanyModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CompanyModelFetchResult

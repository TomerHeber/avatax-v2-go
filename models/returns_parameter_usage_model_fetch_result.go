...
func (m *ReturnsParameterUsageModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnsParameterUsageModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ReturnsParameterUsageModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnsParameterUsageModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ReturnsParameterUsageModelFetchResult

...
func (m *TaxAuthorityModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxAuthorityModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxAuthorityModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxAuthorityModelFetchResult

...
func (m *LocationParameterModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LocationParameterModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *LocationParameterModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LocationParameterModelFetchResult) UnmarshalBinary(b []byte) error {
	var res LocationParameterModelFetchResult

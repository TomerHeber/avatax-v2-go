...
func (m *TaxAuthorityFormModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TaxAuthorityFormModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TaxAuthorityFormModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaxAuthorityFormModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TaxAuthorityFormModelFetchResult

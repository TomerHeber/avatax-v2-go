...
func (m *CertExpressInvitationModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CertExpressInvitationModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CertExpressInvitationModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CertExpressInvitationModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CertExpressInvitationModelFetchResult

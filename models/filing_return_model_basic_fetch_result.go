...
func (m *FilingReturnModelBasicFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FilingReturnModelBasicFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *FilingReturnModelBasicFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FilingReturnModelBasicFetchResult) UnmarshalBinary(b []byte) error {
	var res FilingReturnModelBasicFetchResult

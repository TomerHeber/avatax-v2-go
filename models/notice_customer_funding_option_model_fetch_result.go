...
func (m *NoticeCustomerFundingOptionModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeCustomerFundingOptionModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeCustomerFundingOptionModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeCustomerFundingOptionModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeCustomerFundingOptionModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeCustomerFundingOptionModelFetchResult

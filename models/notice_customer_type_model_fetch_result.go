...
func (m *NoticeCustomerTypeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeCustomerTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeCustomerTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeCustomerTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeCustomerTypeModelFetchResult

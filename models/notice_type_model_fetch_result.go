...
func (m *NoticeTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeTypeModelFetchResult

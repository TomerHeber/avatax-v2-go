...
func (m *CommunicationsTransactionTypeModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CommunicationsTransactionTypeModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CommunicationsTransactionTypeModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CommunicationsTransactionTypeModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommunicationsTransactionTypeModelFetchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CommunicationsTransactionTypeModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CommunicationsTransactionTypeModelFetchResult

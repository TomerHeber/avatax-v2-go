...
func (m *TransactionModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *TransactionModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TransactionModelFetchResult) UnmarshalBinary(b []byte) error {
	var res TransactionModelFetchResult

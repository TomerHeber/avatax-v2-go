...
func (m *CompanyDistanceThresholdModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CompanyDistanceThresholdModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *CompanyDistanceThresholdModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CompanyDistanceThresholdModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CompanyDistanceThresholdModelFetchResult) UnmarshalBinary(b []byte) error {
	var res CompanyDistanceThresholdModelFetchResult

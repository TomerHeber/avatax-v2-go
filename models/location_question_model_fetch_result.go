...
func (m *LocationQuestionModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LocationQuestionModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *LocationQuestionModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LocationQuestionModelFetchResult) UnmarshalBinary(b []byte) error {
	var res LocationQuestionModelFetchResult

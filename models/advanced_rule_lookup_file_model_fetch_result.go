...
func (m *AdvancedRuleLookupFileModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AdvancedRuleLookupFileModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *AdvancedRuleLookupFileModelFetchResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AdvancedRuleLookupFileModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AdvancedRuleLookupFileModelFetchResult) UnmarshalBinary(b []byte) error {
	var res AdvancedRuleLookupFileModelFetchResult

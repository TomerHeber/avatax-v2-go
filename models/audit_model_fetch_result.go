...
func (m *AuditModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *AuditModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {

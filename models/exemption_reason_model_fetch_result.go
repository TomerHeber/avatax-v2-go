...
func (m *ExemptionReasonModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExemptionReasonModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ExemptionReasonModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExemptionReasonModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ExemptionReasonModelFetchResult

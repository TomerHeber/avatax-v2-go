...
func (m *ItemParameterModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *ItemParameterModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItemParameterModelFetchResult) UnmarshalBinary(b []byte) error {
	var res ItemParameterModelFetchResult

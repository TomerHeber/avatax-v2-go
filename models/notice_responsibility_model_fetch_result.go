...
func (m *NoticeResponsibilityModelFetchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NoticeResponsibilityModelFetchResult) validateValue(formats strfmt.Registry) error {
...
func (m *NoticeResponsibilityModelFetchResult) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NoticeResponsibilityModelFetchResult) UnmarshalBinary(b []byte) error {
	var res NoticeResponsibilityModelFetchResult
